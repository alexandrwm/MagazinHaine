...
namespace BeStreet.BusinessLogic.DbContexts
{
    public class BeStreetContext : DbContext
    {
        ...
        {
            modelBuilder.Entity<BuyDtl>()
                .HasKey(e => new { e.BuyId, e.PdId })
                .Property(e => e.BuyId)
                    .HasMaxLength(50)
                    .HasColumnName("BuyID");
                .Property(e => e.PdId)
                    .HasMaxLength(50)
                    .HasColumnName("PdID");
                .Property(e => e.BdtlMoney).HasColumnName("BDtlMoney");
                .Property(e => e.BdtlPrice).HasColumnName("BDtlPrice");
                .Property(e => e.BdtlQty).HasColumnName("BDtlQty");
